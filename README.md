...
In high-volume electronics production, every board must pass a multi-step test sequence before shipment. Most test steps are redundant, they do not detect any defects. This work proposes a framework that:
